    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn1:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Azzah Afifah Veronica");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NIM, "21120118130049");
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_dial_num:
                String phoneNumber = "085591229193";
